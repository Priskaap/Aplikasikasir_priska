...
String  harga,idproduk,idprodukpenjualan,iddetail,jam,tanggal,sub_total;
    ...
    public void cari(){
    try {
        String sql="select * from tbl_produk where ProdukID LIKE '%"+txtcari.getText()+"%'";
        pst=konek.prepareStatement(sql);
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/icons8-new-product-20.png"))); // NOI18N
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/icons8-return-20.png"))); // NOI18N
        ...
        btnbayar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/icons8-money-transfer-20.png"))); // NOI18N
        btnbayar.setText("BAYAR");

        btnbaru.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btnbaru.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/icons8-new-20.png"))); // NOI18N
